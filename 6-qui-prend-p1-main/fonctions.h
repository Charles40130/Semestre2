...
/* Entrée(s) :  ... */
/* Sortie(s) :  ... */
void plateau_de_jeu(cartes plateau[4][6]);
...
void lignecomplete(cartes plateau[4][6],cartes cartes_ramassees_joueurs[][30],int j);
int verifpts(int nb_joueurs,cartes cartes_ramassees_joueurs[][30]);
